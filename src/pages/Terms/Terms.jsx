  ...
  return (
    <div>
      ...
      <section className='Terms__content'>
        ...
        <p>[Trust Crypto Investment] is available to the general public and is opened only to the qualified members of [Trust Crypto Investment], the use of this site is restricted to our members and to individuals personally invited by them. Every deposit is considered to be a private transaction between the [Trust Crypto Investment] and its Member.</p>
        ...
        <p>You agree that all information, communications, materials coming from [Trust Crypto Investment] are unsolicited and must be kept private, confidential and protected from any disclosure. Moreover, the information, communications and materials contained herein are not to be regarded as an offer, nor a solicitation for investments in any jurisdiction which deems non-public offers or solicitations unlawful, nor to any person to whom it will be unlawful to make such offer or solicitation.</p>
        <p>All the data giving by a member to [Trust Crypto Investment] will be only privately used and not disclosed to any third parties. [Trust Crypto Investment] is not responsible or liable for any loss of data.</p>
        ...
        <p>[Trust Crypto Investment] is not responsible or liable for any damages, losses and costs resulting from any violation of the conditions and terms and/or use of our website by a member. You guarantee to [Trust Crypto Investment] that you will not use this site in any illegal way and you agree to respect your local, national and international laws.</p>
        ...
        <p>[Trust Crypto Investment] reserves the right to accept or decline any member for membership without explanation.</p>
